...
public class content_register_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_register_screen);
    }
    ...
    private class QueryActiveEmployeeCountsTask extends AsyncTask<Void, Void, ActiveEmployeeCounts> {
        ...
        protected void onPostExecute(ActiveEmployeeCounts param) {
            ...
            new AlertDialog.Builder(content_register_screen.this).
                    setMessage(R.string.alert_dialog_no_employees_exist).
                    setPositiveButton(
                            R.string.button_ok,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    startActivity(new Intent(getApplicationContext(), create_employee.class));
    ...
    private class SignInTask extends AsyncTask<EmployeeLogin, Void, Employee> {
        ...
        protected void onPreExecute() {
            this.signInAlert = new AlertDialog.Builder(content_register_screen.this).
